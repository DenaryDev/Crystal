 ...
 */
package me.denarydev.crystal.paper.utils.item;

import com.google.common.base.Preconditions;
import me.denarydev.crystal.paper.utils.ItemUtils;
 ...
 * <p>
 * Для создания предмета с нуля, используйте {@link #empty()}.
 * <p>
 * Для создания предмета на основе другого предмета,
...
public class ItemBuilder {
     ...
     * @return {@link ItemBuilder} для дальнейшего использования.
     */
    public ItemBuilder textureBase64(@NotNull final String texture) {
    ...
    public ItemStack build() {
        ...
        if (baseStack != null) {
            ...
            if (textureBase64 != null) {
                final var skullMeta = (SkullMeta) ItemUtils.createHead(textureBase64).getItemMeta();
            ...
            if (textureBase64 != null) {
                item = ItemUtils.createHead(textureBase64, amount);
            } else if (type != null) {
        ...
        if (meta instanceof PotionMeta potion) {
            if (potionType != null) {
                potion.setBasePotionData(new PotionData(potionType));
            }
